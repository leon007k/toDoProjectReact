    ...
    <>
      {
        task.map(taskToDo => (
          <Card
            key={taskToDo?.id}
            titleTask={taskToDo?.title}
            cardBodyContent={taskToDo?.description}
            taskIsDone={resolvedTasks[taskToDo?.id]}
          >
            <div className='card-footer btn-group'>
              <Button typeButton='button' addClassName={'btn-task-done'} actionButton={() => toggleResolvedTask(taskToDo.id)}>
              ...
              <Button typeButton='button' addClassName={'btn-edit-task'} actionButton={() => editTaskHandler(taskToDo.id)}>
              ...
              <Button typeButton='button' addClassName={'btn-delete-task'} actionButton={() => deleteTaskHandler(taskToDo.id)}>
